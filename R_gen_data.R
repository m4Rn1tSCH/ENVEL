...
create$GEXP2 - round((create$GEXP1 + (create$GEXP1Randnum1) + (create$Student1500)), digits = 2)
...
Randnum1 - runif(500000, -0.3, 0.5)
create$GEXP3 - round((create$GEXP2 + (create$GEXP2Randnum1) + (create$Student1500)), digits = 2)
Randnum2 - runif(500000, -0.3, 0.5)
