# -*- coding: utf-8 -*-
"""
Created on Wed Nov 13 11:36:30 2019
...
#this generates an endless loop but works; it is based on Dmitris data so it might be correct
for i in range(len(df.index)):
    ...
    for BillVendor in BillVendors:
        ...
        #print(BillVendor)
        if re.search(pattern = BillVendor, string = descriptions):
